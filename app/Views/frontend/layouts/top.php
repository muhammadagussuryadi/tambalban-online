  ...
  <div class="container">
    <div class="main-header-left ">
      ...
      <a class="header-brand" href="index.html">
        <img src="<?= base_url()?>/assets/img/brand/logo-white.png" class="logo-white " style="height: 3.5rem !important;">
    ...
    <div class="main-header-right">
      ...
      <div class="nav nav-item  navbar-nav-right ml-auto">
        ...
        <div class="nav-item full-screen">
          <a class="new nav-link" href="/login">
    ...
    <div class="horizontal-mainwrapper container clearfix">
      <nav class="horizontalMenu clearfix">
        <ul class="horizontalMenu-list">
          <li aria-haspopup="true"><a href="/" class=""><i class="fe fe-settings  menu-icon"></i>Bengkel</a></li>
          <li aria-haspopup="true"><a href="/be/dashboard" class=""><i class="fe fe-user"></i> Login</a></li>
        </ul>
      </nav>
    </div>
  </div>
